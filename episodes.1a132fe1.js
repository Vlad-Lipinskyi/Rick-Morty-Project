...
const makeMarkUp = (data)=>{
    ...
    <li class="characters__item">
              ...
              <div class="characters__box">
                ...
                <p class="characters__subtitle">${element.origin.name === "unknown" ? "" : cutDimension()}</p>
              </div>
              <div class="characters__box">
                <p class="characters__subtitle-gray">Location: </p>
                <p class="characters__subtitle">${element.location.name === "unknown" ? "" : cutDimensionLocation()}</p>
              </div>
          </li>
    `;
...
const filterEpisodesBySeason = (seasonValue)=>{
    if (!seasonValue) return allEpisodes;
    const seasonNumber = {
        "first-season": "1",
        "second-season": "2",
        "third-season": "3",
...
if (seasonSelect !== null) seasonSelect.addEventListener("change", (e)=>{
    const selectedSeason = e.target.value;
    const filteredEpisodes = filterEpisodesBySeason(selectedSeason);
    episodesList.innerHTML = (0, _makeMarkupEpisdoesJs.makeMarkUpEpisodes)(filteredEpisodes);
});
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getEpisodesAPI", ()=>getEpisodesAPI);
const getEpisodesAPI = async ()=>await fetch("https://rickandmortyapi.com/api/episode").then((respons)=>respons.json());

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5f92Q":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "makeMarkUpEpisodes", ()=>makeMarkUpEpisodes);
var _seasonOneJpg = require("../../img/season-one.jpg");
var _seasonOneJpgDefault = parcelHelpers.interopDefault(_seasonOneJpg);
var _seasonTwoJpg = require("../../img/season-two.jpg");
var _seasonTwoJpgDefault = parcelHelpers.interopDefault(_seasonTwoJpg);
var _seasonThreeJpg = require("../../img/season-three.jpg");
var _seasonThreeJpgDefault = parcelHelpers.interopDefault(_seasonThreeJpg);
var _seasonFourJpg = require("../../img/season-four.jpg");
var _seasonFourJpgDefault = parcelHelpers.interopDefault(_seasonFourJpg);
var _seasonFiveJpg = require("../../img/season-five.jpg");
var _seasonFiveJpgDefault = parcelHelpers.interopDefault(_seasonFiveJpg);
var _seasonSixJpg = require("../../img/season-six.jpg");
var _seasonSixJpgDefault = parcelHelpers.interopDefault(_seasonSixJpg);
const makeMarkUpEpisodes = (data)=>data.map((element)=>{
        let imgUrl = null;
        let season = element.episode.slice(2, 3);
        console.log(season);
        if (season === "1") imgUrl = (0, _seasonOneJpgDefault.default);
        else if (season === "2") imgUrl = (0, _seasonTwoJpgDefault.default);
        else if (season === "3") imgUrl = (0, _seasonThreeJpgDefault.default);
        else if (season === "4") imgUrl = (0, _seasonFourJpgDefault.default);
        else if (season === "5") imgUrl = (0, _seasonFiveJpgDefault.default);
        else if (season === "6") imgUrl = (0, _seasonSixJpgDefault.default);
        const makeEpisodes = `
...
if (buttonShowMore !== null) buttonShowMore.addEventListener("click", ()=>{
    perPage += 4;
    showItems(perPage);
});
